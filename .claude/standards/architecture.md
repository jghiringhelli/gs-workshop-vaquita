<!-- ForgeCraft sentinel: architecture | 2026-04-03 | npx forgecraft-mcp refresh . --apply to update -->

## Project Identity
- **Repo**: https://github.com/pragma-works/gs-workshop-vaquita
- **Primary Language**: typescript
- **Framework**: Express
- **Domain**: financial technology
- **Sensitive Data**: YES
- **Project Tags**: `[UNIVERSAL]` `[API]` `[DATABASE]` `[LIBRARY]` `[FINTECH]`
