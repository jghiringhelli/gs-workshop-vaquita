...
- C:\workspace\PragmaWorks\DX\gs-workshop-vaquita-b\CLAUDE.md
- C:\workspace\PragmaWorks\DX\gs-workshop-vaquita-b\docs\PRD.md
- C:\workspace\PragmaWorks\DX\gs-workshop-vaquita-b\docs\use-cases.md
...
You are starting the first implementation session for **gs-workshop-vaquita-b**.
